...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 手机远程操作 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 手机远程操作 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 手机远程操作 使用\"无障碍\"服务。"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 手机远程操作 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 手机远程操作 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 手机远程操作 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 手机远程操作 \"录音\"权限。"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "你可能被骗了！"),
        ("scam_text1", "如果你正在和素不相识的人通话，而对方要求你使用 手机远程操作 启动服务，请勿继续操作并立刻挂断电话。"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 手机远程操作 后台服务"),
